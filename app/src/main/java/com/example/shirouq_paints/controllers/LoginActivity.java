...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private RadioGroup Select_Language;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Select_Language = (RadioGroup) findViewById(R.id.Select_Language);
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int selectedId = Select_Language.getCheckedRadioButtonId();
                selectedLang = (RadioButton) findViewById(selectedId);
                Lang = selectedLang.getText().toString();
                attemptLogin();
            }
        });
